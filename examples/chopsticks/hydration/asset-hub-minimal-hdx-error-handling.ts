...
async function main() {
    ...
    try {
        ...
        const dotFeeAsset = {
            ...
            fun: XcmV3MultiassetFungibility.Fungible(TRANSFER_AMOUNT / 50n) // 50% for fees
        };
        ...
        //random query id with bigInt
        const QUERY_ID = BigInt(Math.random() * 1000000000000000000)
        ...
        const message = XcmVersionedXcm.V4([
            ...
            XcmV4Instruction.DepositReserveAsset({
                ...
                xcm: [
                    ...
                    // 2d. Report transaction status back to Asset Hub
                    // XcmV4Instruction.ReportTransactStatus({
                    //     query_id: QUERY_ID,
                    //     destination: {
                    //         parents: 1,
                    //         interior: XcmV3Junctions.X1(
                    ...
                    //     }
                    // })
                    // Set error handler to report errors back to Asset Hub
                    XcmV4Instruction.SetErrorHandler([
                        XcmV4Instruction.ReportError({
                            query_id: QUERY_ID,
                            destination: {
                                parents: 1,
                                interior: XcmV3Junctions.X1(
                    ...
                    XcmV4Instruction.ExpectTransactStatus({
                        type: "Success",
                        value: undefined
                    }),
                ]
